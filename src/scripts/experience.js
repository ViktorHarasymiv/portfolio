...
const experience = [
  {
    ...
    about:
      'I have gone through a lot of material and self-study courses. I have a lot of practice in HTML, CSS, JS, REACT, REACT REDUX',
    skills: [
      skillsValueExp[0],
      skillsValueExp[1],
      skillsValueExp[2],
  ...
  },
  {
    ...
    about:
      'Junior Fullstack Developer з повним циклом створення сучасних вебсайтів та вебзастосунків з нуля за 10 місяців',
    skills: [
      skillsValueExp[0],
      skillsValueExp[1],
      skillsValueExp[2],
